...
(cl:defmethod cl:initialize-instance :after ((m <Velocity-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocity-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim_controller-srv:<Velocity-request> is deprecated: use turtlesim_controller-srv:Velocity-request instead.")))

(cl:ensure-generic-function 'min-val :lambda-list '(m))
(cl:defmethod min-val ((m <Velocity-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim_controller-srv:min-val is deprecated.  Use turtlesim_controller-srv:min instead.")
  (min m))

(cl:ensure-generic-function 'max-val :lambda-list '(m))
(cl:defmethod max-val ((m <Velocity-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim_controller-srv:max-val is deprecated.  Use turtlesim_controller-srv:max instead.")
  (max m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Velocity-request>)))
  ...
  "turtlesim_controller/VelocityRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Velocity-request)))
  "Returns string type for a service object of type 'Velocity-request"
  "turtlesim_controller/VelocityRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Velocity-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocity-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim_controller-srv:<Velocity-response> is deprecated: use turtlesim_controller-srv:Velocity-response instead.")))
...
(cl:defmethod z-val ((m <Velocity-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim_controller-srv:z-val is deprecated.  Use turtlesim_controller-srv:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Velocity-response>)))
  ...
  "turtlesim_controller/VelocityResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Velocity-response)))
  "Returns string type for a service object of type 'Velocity-response"
  "turtlesim_controller/VelocityResponse")
