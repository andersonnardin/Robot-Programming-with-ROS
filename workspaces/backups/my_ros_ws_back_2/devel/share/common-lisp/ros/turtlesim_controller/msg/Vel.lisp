...
(cl:in-package turtlesim_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Vel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim_controller-msg:<Vel> is deprecated: use turtlesim_controller-msg:Vel instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Vel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim_controller-msg:name-val is deprecated.  Use turtlesim_controller-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <Vel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim_controller-msg:vel-val is deprecated.  Use turtlesim_controller-msg:vel instead.")
  (vel m))
